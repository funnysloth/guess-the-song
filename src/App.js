...
const tracks = {
  Казу: ["Somewhere in my memory", "Carol of the Bells", "All I Want for Christmas is You"],
  "Окей Гугл": ["Let it snow", "Last Christmas", "It's the most wonderful time of the year"],
  Реверс: ["Чи знала ти, Маріє", "Тиха ніч", "Нова радість"],
  "Без зайвих слів": ["Радуйся світ", "Небо і земля нині торжествують", "Бог ся рождає"],
  "Без зайвих слів 2": ["Jingle bell rock", "Jinglle bells", "Rockin' around the Christmas tree"],
  ДоРеМікси: ["You're a mean one Mr. Grinch", "Feliz Navidad", "Лускунчик"],
  Гітара: ["Добрий вечір тобі", "We wish you a merry Christmas", "Різдвяна (слав Царя усе творіння)"],
};
...
function App() {
  ...
  const [backgroundAudio] = useState(new Audio('songs/Backgroung Relaxing Jazz.mp3'));
